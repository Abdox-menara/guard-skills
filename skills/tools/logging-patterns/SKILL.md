...
author: Abdox
description: |
  ULTRA-ADVANCED Logging Patterns - Logging patterns - structured, levels, correlation ID, sampling, context
  ...
  TRIGGER PHRASES: "logging patterns, structured logging, log correlation"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Logging Patterns - ULTRA-ADVANCED v1.0

## Overview

Logging patterns - structured, levels, correlation ID, sampling, context. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Unstructured format | Logs not machine parseable | high |
| Wrong log level | Info vs debug misuse | low |
| Missing correlation ID | Request not traceable across services | high |
| Over-logging | Too much noise per request | medium |
| Under-logging errors | Exceptions without context | high |
...
- [logging-stack](../logging-stack/SKILL.md)
