...
author: Abdox
description: |
  ULTRA-ADVANCED Api Versioning - API versioning strategy - URI, header, content negotiation, deprecation
  ...
  TRIGGER PHRASES: "api versioning, rest versioning, backward compatibility"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Api Versioning - ULTRA-ADVANCED v1.0

## Overview

API versioning strategy - URI, header, content negotiation, deprecation. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Breaking change unversioned | No version bump on breaking change | critical |
| Too many active versions | More than 3 supported versions | medium |
| No deprecation notice | Breaking change without warning | high |
| No sunset date | No end-of-life schedule | medium |
| No migration guide | Upgrade instructions missing | medium |
