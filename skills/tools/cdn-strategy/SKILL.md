...
author: Abdox
description: |
  ULTRA-ADVANCED Cdn Strategy - CDN strategy - edge caching, origin shield, dynamic acceleration, compression
  ...
  TRIGGER PHRASES: "cdn strategy, content delivery, edge caching"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Cdn Strategy - ULTRA-ADVANCED v1.0

## Overview

CDN strategy - edge caching, origin shield, dynamic acceleration, compression. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Static content uncached | No cache headers on static assets | high |
| No Cache-Control header | Browser caching not configured | high |
| No purge on update | Old content remains after deployment | medium |
| No origin shield | All requests hit origin directly | medium |
| Mixed content | HTTP resources on HTTPS page | critical |
