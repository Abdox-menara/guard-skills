...
author: Abdox
description: |
  ULTRA-ADVANCED Backup Strategy - Backup strategy - frequency, retention, offsite, encryption, recovery testing
  ...
  TRIGGER PHRASES: "backup strategy, backup and restore, disaster recovery"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Backup Strategy - ULTRA-ADVANCED v1.0

## Overview

Backup strategy - frequency, retention, offsite, encryption, recovery testing. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No backup schedule | No automated backups configured | critical |
| No offsite backup | All backups in single location | critical |
| Retention too short | Less than 30 day retention | high |
| No recovery tested | Restore never verified | critical |
| No incremental backup | Full backup only strategy | medium |
