...
author: Abdox
description: |
  ULTRA-ADVANCED Query Optimization - Query optimization - execution plans, rewriting, statistics, indexing hints
  ...
  TRIGGER PHRASES: "query optimization, sql tuning, execution plan"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Query Optimization - ULTRA-ADVANCED v1.0

## Overview

Query optimization - execution plans, rewriting, statistics, indexing hints. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Full table scan | Missing index on filter column | high |
| SELECT star usage | Unnecessary column retrieval | low |
| Missing JOIN index | JOIN column not indexed | high |
| Inefficient subquery | Subquery without optimization | medium |
| No LIMIT clause | Unbounded result sets | medium |
