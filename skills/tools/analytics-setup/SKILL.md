...
author: Abdox
description: |
  ULTRA-ADVANCED Analytics Setup - Analytics implementation - event tracking, taxonomy, dashboards, privacy
  ...
  TRIGGER PHRASES: "analytics, event tracking, user behavior"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Analytics Setup - ULTRA-ADVANCED v1.0

## Overview

Analytics implementation - event tracking, taxonomy, dashboards, privacy. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No event taxonomy | Events without naming convention | medium |
| Missing key events | Critical user actions untracked | high |
| No funnel tracking | Conversion steps not measured | high |
| PII in analytics | Personal data sent to analytics | critical |
| No dashboard | Data collected but not visualized | high |
