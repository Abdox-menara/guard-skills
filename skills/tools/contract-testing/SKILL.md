...
author: Abdox
description: |
  ULTRA-ADVANCED Contract Testing - Contract testing - consumer-driven contracts, provider verification, Pact
  ...
  TRIGGER PHRASES: "contract testing, pact, consumer driven contracts"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Contract Testing - ULTRA-ADVANCED v1.0

## Overview

Contract testing - consumer-driven contracts, provider verification, Pact. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No contract verification | Provider changes break consumers | high |
| No CI integration | Contract not verified in CI | high |
| Missing consumer tests | Consumer not testing contract | medium |
| Outdated contracts | Not updated with API changes | high |
| No broker integration | No contract sharing mechanism | medium |
