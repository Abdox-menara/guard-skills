...
author: Abdox
description: |
  ULTRA-ADVANCED Database Optimization - Database optimization - query tuning, indexing, connection management, monitoring
  ...
  TRIGGER PHRASES: "database optimization, query tuning, index optimization"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Database Optimization - ULTRA-ADVANCED v1.0

## Overview

Database optimization - query tuning, indexing, connection management, monitoring. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No slow query log | Performance issues undetected | high |
| No connection pooling | Repeated connect/disconnect overhead | high |
| Missing indexes | Full table scans on filter columns | medium |
| N+1 query pattern | Repeated round trips in loops | high |
| No EXPLAIN analysis | Query plans not reviewed | medium |
