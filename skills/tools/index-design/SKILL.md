...
author: Abdox
description: |
  ULTRA-ADVANCED Index Design - Index strategy - B-tree, hash, composite, covering, partial, filtered indexes
  ...
  TRIGGER PHRASES: "index design, database indexing, index strategy"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Index Design - ULTRA-ADVANCED v1.0

## Overview

Index strategy - B-tree, hash, composite, covering, partial, filtered indexes. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| FK without index | Foreign key column not indexed | high |
| Over-indexing | Too many indexes on single table | medium |
| Wrong column order | Cardinality order reversed in composite | medium |
| Redundant indexes | Overlapping index definitions | medium |
| No covering index | Key lookup needed for frequent query | medium |
