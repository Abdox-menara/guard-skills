...
author: Abdox
description: |
  ULTRA-ADVANCED Alerting Stack - Alerting stack - rules, routing, escalation, silencing, runbooks
  ...
  TRIGGER PHRASES: "alerting, alertmanager, pagerduty, on call"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Alerting Stack - ULTRA-ADVANCED v1.0

## Overview

Alerting stack - rules, routing, escalation, silencing, runbooks. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Alert fatigue | Too many low-severity alerts | high |
| No severity levels | All alerts same priority | medium |
| No escalation path | Unacknowledged alert ignored | high |
| No runbook link | Alert without instructions | medium |
| No silencing | Maintenance causes alert noise | medium |
