...
author: Abdox
description: |
  ULTRA-ADVANCED Accessibility Patterns - Accessibility patterns - ARIA, keyboard navigation, screen reader, color contrast
  ...
  TRIGGER PHRASES: "accessibility, a11y, inclusive design"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Accessibility Patterns - ULTRA-ADVANCED v1.0

## Overview

Accessibility patterns - ARIA, keyboard navigation, screen reader, color contrast. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Missing ARIA labels | Interactive elements not labeled | high |
| Keyboard trap | Focus cannot leave an element | critical |
| Low color contrast | Text below 4.5:1 ratio | high |
| No focus indicator | Keyboard user cannot see focus | high |
| No skip link | No skip to main content link | medium |
