...
author: Abdox
description: |
  ULTRA-ADVANCED Tracing Stack - Distributed tracing - OpenTelemetry, instrumentation, sampling, correlation
  ...
  TRIGGER PHRASES: "distributed tracing, opentelemetry, jaeger"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Tracing Stack - ULTRA-ADVANCED v1.0

## Overview

Distributed tracing - OpenTelemetry, instrumentation, sampling, correlation. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Missing trace context | No trace propagation headers | high |
| Sampling too high | Performance impact from tracing | medium |
| Incomplete spans | Span missing critical attributes | medium |
| No trace-log correlation | trace_id not in log entries | medium |
| No service map | Dependency graph not visible | medium |
