...
author: Abdox
description: |
  ULTRA-ADVANCED Monitoring Stack - Monitoring stack design - metrics collection, storage, visualization, alerting
  ...
  TRIGGER PHRASES: "monitoring stack, prometheus, grafana, metrics"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Monitoring Stack - ULTRA-ADVANCED v1.0

## Overview

Monitoring stack design - metrics collection, storage, visualization, alerting. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No alert channel | Alerts have no destination | high |
| No dashboard | No visualization of metrics | medium |
| No retention policy | Storage grows unbounded | medium |
| No HA monitoring | Monitoring is single point of failure | high |
| Missing service metrics | Not all services instrumented | medium |
