...
author: Abdox
description: |
  ULTRA-ADVANCED Image Optimization - Image optimization - format selection, compression, responsive images, lazy loading
  ...
  TRIGGER PHRASES: "image optimization, webp, avif, responsive images"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Image Optimization - ULTRA-ADVANCED v1.0

## Overview

Image optimization - format selection, compression, responsive images, lazy loading. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Wrong format | No WebP/AVIF for modern browsers | medium |
| No compression | Images at full quality unnecessarily | high |
| No responsive images | Same image for all screen sizes | medium |
| No lazy loading | Below-fold images load immediately | medium |
| Missing dimensions | Layout shift without width/height | high |
