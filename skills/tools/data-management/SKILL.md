...
author: Abdox
description: |
  ULTRA-ADVANCED Data Management - Data management - lifecycle, classification, governance, quality, lineage, retention
  CAPABILITIES:
  - 8 anti-pattern detection patterns with severity scoring
  - Compliance scoring (A-F grade) with weighted severity model
  - Standards-based detection (DAMA-DMBOK; DCAM; GDPR; NIST)
  - Automated fix suggestion generation
  - Directory scanning with aggregated reporting
  TRIGGER PHRASES: "data management, data governance, data lifecycle"
  STANDARDS: DAMA-DMBOK; DCAM; GDPR; NIST
  ENVIRONMENT: Works with any codebase, any language, any framework.
  SECURITY: Read-only analysis.
---

# Data Management - ULTRA-ADVANCED v2.0

## Overview

Data management - lifecycle, classification, governance, quality, lineage, retention. This guard scans codebases for violations, scores compliance,
