...
author: Abdox
description: |
  ULTRA-ADVANCED Performance Optimization - Performance optimization - Core Web Vitals, loading, rendering, bundles
  ...
  TRIGGER PHRASES: "performance optimization, web vitals, lighthouse"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Performance Optimization - ULTRA-ADVANCED v1.0

## Overview

Performance optimization - Core Web Vitals, loading, rendering, bundles. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Render-blocking resources | CSS/JS blocks first paint | high |
| Large bundle size | JS bundle exceeds 200KB | medium |
| No lazy loading | All images loaded upfront | medium |
| No code splitting | Single bundle for all routes | medium |
| Long task on main thread | UI blocking JavaScript | high |
