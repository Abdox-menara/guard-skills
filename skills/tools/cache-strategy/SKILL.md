...
author: Abdox
description: |
  ULTRA-ADVANCED Cache Strategy - Cache strategy - TTL, invalidation, warming, hierarchy, distributed patterns
  ...
  TRIGGER PHRASES: "cache strategy, caching, cache invalidation"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Cache Strategy - ULTRA-ADVANCED v1.0

## Overview

Cache strategy - TTL, invalidation, warming, hierarchy, distributed patterns. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No TTL on cache | Cache grows unbounded | high |
| No invalidation strategy | Stale data served indefinitely | critical |
| Cache stampede risk | Concurrent rebuild on cache miss | high |
| No cache warming | Cold start performance penalty | medium |
| No cache monitoring | Hit rate not tracked | medium |
