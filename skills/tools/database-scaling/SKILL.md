...
author: Abdox
description: |
  ULTRA-ADVANCED Database Scaling - Database scaling strategy - read replicas, sharding, partitioning, connection pooling
  ...
  TRIGGER PHRASES: "database scaling, sharding, read replica"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Database Scaling - ULTRA-ADVANCED v1.0

## Overview

Database scaling strategy - read replicas, sharding, partitioning, connection pooling. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Missing read replicas | Read/write on same instance | high |
| Bad sharding key | Uneven data distribution | critical |
| No rebalancing plan | Cannot add new shards | medium |
| Cross-shard queries | Orphaned data across shards | high |
| No failover replicas | Read replica single point of failure | high |
