...
author: Abdox
description: |
  ULTRA-ADVANCED Microservice Patterns - Microservice patterns - bounded context, API gateway, service discovery, database per service
  CAPABILITIES:
  - 8 anti-pattern detection patterns with severity scoring
  - Compliance scoring (A-F grade) with weighted severity model
  - Standards-based detection (Sam Newman Building Microservices; Chris Richardson)
  - Automated fix suggestion generation
  - Directory scanning with aggregated reporting
  TRIGGER PHRASES: "microservice patterns, microservices architecture"
  STANDARDS: Sam Newman Building Microservices; Chris Richardson
  ENVIRONMENT: Works with any codebase, any language, any framework.
  SECURITY: Read-only analysis.
---

# Microservice Patterns - ULTRA-ADVANCED v2.0

## Overview

Microservice patterns - bounded context, API gateway, service discovery, database per service. This guard scans codebases for violations, scores compliance,
