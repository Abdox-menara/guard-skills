...
author: Abdox
description: |
  ULTRA-ADVANCED Cicd Pipeline - CI/CD pipeline design - stages, gates, caching, optimization, security scanning
  ...
  TRIGGER PHRASES: "cicd, continuous delivery, pipeline design"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Cicd Pipeline - ULTRA-ADVANCED v1.0

## Overview

CI/CD pipeline design - stages, gates, caching, optimization, security scanning. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Missing test stage | No automated tests in pipeline | critical |
| Long pipeline time | Pipeline exceeds 30 minutes | medium |
| No caching | Dependencies reinstalled every run | medium |
| No artifact versioning | Build outputs not uniquely tagged | high |
| No security scan | SAST or dependency scan missing | high |
