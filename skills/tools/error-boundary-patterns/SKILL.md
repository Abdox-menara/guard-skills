...
author: Abdox
description: |
  ULTRA-ADVANCED Error Boundary Patterns - Error boundary patterns - React error boundaries, graceful degradation, recovery
  ...
  TRIGGER PHRASES: "error boundary, error handling, graceful degradation"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Error Boundary Patterns - ULTRA-ADVANCED v1.0

## Overview

Error boundary patterns - React error boundaries, graceful degradation, recovery. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No error boundary | Unhandled errors crash application | high |
| Error boundary too broad | One boundary wraps entire app | medium |
| No fallback UI | Blank screen instead of fallback | high |
| Errors swallowed | Error logged nowhere | high |
| No recovery mechanism | No retry in fallback UI | medium |
