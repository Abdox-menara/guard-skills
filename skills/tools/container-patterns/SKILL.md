...
author: Abdox
description: |
  ULTRA-ADVANCED Container Patterns - Container/Docker patterns - image optimization, multi-stage, security, layering
  CAPABILITIES:
  - 8 anti-pattern detection patterns with severity scoring
  - Compliance scoring (A-F grade) with weighted severity model
  - Standards-based detection (Docker best practices; CIS Benchmark)
  - Automated fix suggestion generation
  - Directory scanning with aggregated reporting
  TRIGGER PHRASES: "container patterns, docker best practices"
...
# Container Patterns - ULTRA-ADVANCED v2.0

## Overview

Container/Docker patterns - image optimization, multi-stage, security, layering. This guard scans codebases for violations, scores compliance,
