...
author: Abdox
description: |
  ULTRA-ADVANCED Logging Stack - Logging stack design - collection, aggregation, storage, analysis, retention
  ...
  TRIGGER PHRASES: "logging stack, elk, loki, structured logging"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Logging Stack - ULTRA-ADVANCED v1.0

## Overview

Logging stack design - collection, aggregation, storage, analysis, retention. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No log rotation | Logs consume all available disk | high |
| No log levels | Cannot filter by severity | medium |
| Unstructured logs | Logs not machine parseable | critical |
| Sensitive data in logs | PII or secrets in log entries | critical |
| No centralized logging | Logs scattered across instances | high |
