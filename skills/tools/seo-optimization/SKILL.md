...
author: Abdox
description: |
  ULTRA-ADVANCED Seo Optimization - SEO optimization - technical SEO, content, structured data, performance, meta tags
  ...
  TRIGGER PHRASES: "seo, search optimization, meta tags, structured data"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Seo Optimization - ULTRA-ADVANCED v1.0

## Overview

SEO optimization - technical SEO, content, structured data, performance, meta tags. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Missing meta description | Search result snippet empty | medium |
| No heading hierarchy | h1-h6 order incorrect | medium |
| Missing alt text | Images without alt attributes | high |
| No canonical URL | Duplicate content risk | medium |
| No structured data | Schema.org markup missing | medium |
...
- [seo-guard](../../guards/seo-guard/SKILL.md)
