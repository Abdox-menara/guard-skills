...
author: Abdox
description: |
  ULTRA-ADVANCED Zero Downtime Deployment - Zero-downtime deployment - rolling, blue-green, canary, migration patterns
  ...
  TRIGGER PHRASES: "zero downtime deployment, rolling update, blue green"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Zero Downtime Deployment - ULTRA-ADVANCED v1.0

## Overview

Zero-downtime deployment - rolling, blue-green, canary, migration patterns. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No health check gate | Deploy without health validation | critical |
| No rollback plan | Failed deploy without recovery | high |
| DB migration incompatible | Breaking schema change in deploy | critical |
| Insufficient replicas | Fewer than 2 during deployment | high |
| No traffic draining | Active connections interrupted | medium |
