...
author: Abdox
description: |
  ULTRA-ADVANCED Design System - Design system creation - components, design tokens, documentation, distribution
  ...
  TRIGGER PHRASES: "design system, component library, ui kit, storybook"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Design System - ULTRA-ADVANCED v1.0

## Overview

Design system creation - components, design tokens, documentation, distribution. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No design tokens | Hardcoded colors/spacing/typography | high |
| Inconsistent components | Same pattern implemented differently | medium |
| No accessibility | Components not keyboard/ARIA compatible | high |
| No documentation | Props and usage not documented | medium |
| No versioning | Breaking changes without notice | medium |
