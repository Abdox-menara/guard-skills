...
author: Abdox
description: |
  ULTRA-ADVANCED Testing Pyramid - Testing pyramid strategy - unit, integration, e2e distribution, coverage goals
  ...
  TRIGGER PHRASES: "testing pyramid, test strategy, test distribution"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Testing Pyramid - ULTRA-ADVANCED v1.0

## Overview

Testing pyramid strategy - unit, integration, e2e distribution, coverage goals. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No unit tests | Base layer of pyramid missing | critical |
| Too many e2e tests | E2E outnumber unit tests | medium |
| No integration tests | Middle layer of pyramid missing | high |
| Tests share state | Test isolation violated | high |
| Flaky tests ignored | Known flaky tests not addressed | medium |
