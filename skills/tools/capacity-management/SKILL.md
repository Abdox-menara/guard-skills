...
author: Abdox
description: |
  ULTRA-ADVANCED Capacity Management - Capacity management - forecasting, monitoring, scaling triggers, planning
  CAPABILITIES:
  - 8 anti-pattern detection patterns with severity scoring
  - Compliance scoring (A-F grade) with weighted severity model
  - Standards-based detection (ITIL Capacity Management; AWS WA)
  - Automated fix suggestion generation
  - Directory scanning with aggregated reporting
  TRIGGER PHRASES: "capacity management, capacity planning, scaling"
  STANDARDS: ITIL Capacity Management; AWS WA
  ENVIRONMENT: Works with any codebase, any language, any framework.
  SECURITY: Read-only analysis.
---

# Capacity Management - ULTRA-ADVANCED v2.0

## Overview

Capacity management - forecasting, monitoring, scaling triggers, planning. This guard scans codebases for violations, scores compliance,
