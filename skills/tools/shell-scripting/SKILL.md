...
author: Abdox
description: |
  ULTRA-ADVANCED Shell Scripting - Shell scripting best practices - error handling, portability, security, quoting
  ...
  TRIGGER PHRASES: "shell script, bash, posix, shellcheck"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Shell Scripting - ULTRA-ADVANCED v1.0

## Overview

Shell scripting best practices - error handling, portability, security, quoting. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No error handling | Missing set -e or error checks | high |
| Unquoted variable | Word splitting risk on expansion | high |
| Deprecated syntax | Backticks instead of $() | medium |
| Not portable | Bash-specific without proper shebang | medium |
| No usage text | Missing help or usage function | low |
