...
author: Abdox
description: |
  ULTRA-ADVANCED Makefile - Makefile best practices - phony targets, variables, dependencies, help
  ...
  TRIGGER PHRASES: "makefile, gnu make, build automation"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Makefile - ULTRA-ADVANCED v1.0

## Overview

Makefile best practices - phony targets, variables, dependencies, help. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Missing .PHONY | File name matches phony target | medium |
| Hardcoded paths | No variable for common paths | medium |
| No help target | Available targets not listed | low |
| Wrong dependencies | Order-only vs normal misuse | medium |
| No clean target | Build artifacts cannot be cleaned | low |
