...
author: Abdox
description: |
  ULTRA-ADVANCED Api Documentation - API documentation - OpenAPI/Swagger spec, docs generation, SDK generation, examples
  ...
  TRIGGER PHRASES: "api documentation, openapi, swagger, api docs"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Api Documentation - ULTRA-ADVANCED v1.0

## Overview

API documentation - OpenAPI/Swagger spec, docs generation, SDK generation, examples. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No API documentation | No OpenAPI spec exists | critical |
| Outdated docs | Spec not matching implementation | high |
| Missing examples | Request/response examples not shown | medium |
| No error documentation | Error codes not documented | medium |
| No auth documentation | Auth flow not described | high |
