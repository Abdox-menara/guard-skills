...
author: Abdox
description: |
  ULTRA-ADVANCED State Management - State management patterns - Redux, Context, signals, proper immutability
  ...
  TRIGGER PHRASES: "state management, redux, context, zustand"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# State Management - ULTRA-ADVANCED v1.0

## Overview

State management patterns - Redux, Context, signals, proper immutability. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Props drilling | Props passing through many levels | medium |
| Redundant state | Derived data stored in state | medium |
| Direct state mutation | State modified directly | high |
| No state normalization | Duplicate entities in state | medium |
| Side effects in reducers | API calls inside reducers | critical |
