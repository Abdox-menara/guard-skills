...
author: Abdox
description: |
  ULTRA-ADVANCED Data Quality - Data quality framework - validation, monitoring, lineage, remediation, ownership
  ...
  TRIGGER PHRASES: "data quality, data validation, data integrity"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Data Quality - ULTRA-ADVANCED v1.0

## Overview

Data quality framework - validation, monitoring, lineage, remediation, ownership. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No data validation | Input data not validated | critical |
| No quality metrics | Data quality not measured | high |
| No anomaly detection | Data drift undetected | high |
| No data profiling | Data distribution unknown | medium |
| No remediation process | Bad data not corrected | high |
