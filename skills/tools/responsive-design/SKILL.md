...
author: Abdox
description: |
  ULTRA-ADVANCED Responsive Design - Responsive design patterns - breakpoints, fluid layouts, mobile-first, testing
  ...
  TRIGGER PHRASES: "responsive design, mobile-first, adaptive layout"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Responsive Design - ULTRA-ADVANCED v1.0

## Overview

Responsive design patterns - breakpoints, fluid layouts, mobile-first, testing. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No viewport meta | Mobile viewport not configured | high |
| Fixed pixel widths | Non-fluid layout breaks on resize | medium |
| No breakpoints | Single column layout at all sizes | medium |
| Touch targets too small | Buttons below 44x44px on mobile | high |
| Horizontal scroll | Content wider than viewport | medium |
