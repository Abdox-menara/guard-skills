...
author: Abdox
description: |
  ULTRA-ADVANCED Incident Response Workflow - Incident response workflow - detection, triage, mitigation, post-mortem, action items
  ...
  TRIGGER PHRASES: "incident response, outage, sev level"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Incident Response Workflow - ULTRA-ADVANCED v1.0

## Overview

Incident response workflow - detection, triage, mitigation, post-mortem, action items. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No severity classification | Incident priority not defined | high |
| No communication template | Stakeholder updates not templated | medium |
| No runbook available | Response steps not documented | high |
| No timeline tracking | Incident timeline not recorded | medium |
| No blameless culture | Post-mortem assigns blame | high |
