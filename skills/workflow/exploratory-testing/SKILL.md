...
author: Abdox
description: |
  ULTRA-ADVANCED Exploratory Testing - Exploratory testing - charters, session notes, timeboxed discovery, debrief
  ...
  TRIGGER PHRASES: "exploratory testing, charter testing, session based testing"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Exploratory Testing - ULTRA-ADVANCED v1.0

## Overview

Exploratory testing - charters, session notes, timeboxed discovery, debrief. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Vague charter | Test mission unclear | medium |
| No timebox | Session without time limit | high |
| Missing session notes | No documentation of findings | medium |
| Surface-level only | Deep exploration not performed | high |
| No debrief | Findings not discussed or shared | medium |
