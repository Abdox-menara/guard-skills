...
author: Abdox
description: |
  ULTRA-ADVANCED Data Pipeline Workflow - Data pipeline workflow - ingestion, transformation, validation, monitoring, lineage
  ...
  TRIGGER PHRASES: "data pipeline, etl workflow, data engineering"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Data Pipeline Workflow - ULTRA-ADVANCED v1.0

## Overview

Data pipeline workflow - ingestion, transformation, validation, monitoring, lineage. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No data validation | Quality checks missing at input | critical |
| No error handling | Pipeline fails on bad records | high |
| Missing data lineage | Source-to-target mapping absent | high |
| Schema changes unmanaged | Breaking schema changes propagate | high |
| No monitoring | Pipeline observability gaps | medium |
