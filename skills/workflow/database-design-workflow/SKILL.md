---
name: database-design-workflow
version: 1.0.0
author: Abdox
description: |
  ULTRA-ADVANCED Database Design Workflow - Database design workflow - schema modeling, normalization, indexing strategy
  ...
  TRIGGER PHRASES: "database design, schema design, data modeling"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Database Design Workflow - ULTRA-ADVANCED v1.0

## Overview

Database design workflow - schema modeling, normalization, indexing strategy. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No schema diagram | Database schema not documented | medium |
| Missing foreign keys | Relationships not enforced | high |
| No indexing strategy | Queries not analyzed for indexes | high |
| No migration plan | Schema changes not versioned | high |
| No data types review | Wrong column types used | medium |
