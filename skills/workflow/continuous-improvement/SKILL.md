...
author: Abdox
description: |
  ULTRA-ADVANCED Continuous Improvement - Continuous improvement workflow - metrics, experiments, kaizen culture, feedback loops
  ...
  TRIGGER PHRASES: "continuous improvement, kaizen, process improvement"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Continuous Improvement - ULTRA-ADVANCED v1.0

## Overview

Continuous improvement workflow - metrics, experiments, kaizen culture, feedback loops. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No baseline metrics | Improvement without measurement | high |
| No experiment design | Change without hypothesis | medium |
| No feedback loop | Results of change not reviewed | medium |
| Not trended | Point measurement without trend data | medium |
| No team involvement | Top-down improvement only | high |
