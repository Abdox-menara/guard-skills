...
author: Abdox
description: |
  ULTRA-ADVANCED Api Design Workflow - API design workflow - contract-first, resource modeling, versioning, documentation
  ...
  TRIGGER PHRASES: "api design, contract-first, api versioning"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Api Design Workflow - ULTRA-ADVANCED v1.0

## Overview

API design workflow - contract-first, resource modeling, versioning, documentation. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No contract first | Implementation before API contract | high |
| Inconsistent naming | API endpoints not following convention | medium |
| Missing error schema | Error responses not standardized | medium |
| No pagination strategy | List endpoints without pagination | high |
| No deprecation policy | Breaking changes without notice | high |
