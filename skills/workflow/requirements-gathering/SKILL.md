...
author: Abdox
description: |
  ULTRA-ADVANCED Requirements Gathering - Requirements gathering - stakeholder interviews, user stories, non-functional, prioritization
  CAPABILITIES:
  - 8 anti-pattern detection patterns with severity scoring
  - Compliance scoring (A-F grade) with weighted severity model
  - Standards-based detection (IEEE 830; BABOK; User Stories Applied)
  - Automated fix suggestion generation
  - Directory scanning with aggregated reporting
  TRIGGER PHRASES: "requirements gathering, requirements elicitation"
  STANDARDS: IEEE 830; BABOK; User Stories Applied
  ENVIRONMENT: Works with any codebase, any language, any framework.
  SECURITY: Read-only analysis.
---

# Requirements Gathering - ULTRA-ADVANCED v2.0

## Overview

Requirements gathering - stakeholder interviews, user stories, non-functional, prioritization. This guard scans codebases for violations, scores compliance,
