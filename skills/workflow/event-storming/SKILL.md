...
author: Abdox
description: |
  ULTRA-ADVANCED Event Storming - Event storming workshop - domain exploration, bounded context discovery, timeline ordering
  ...
  TRIGGER PHRASES: "event storming, domain event, big picture"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Event Storming - ULTRA-ADVANCED v1.0

## Overview

Event storming workshop - domain exploration, bounded context discovery, timeline ordering. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Missing external systems | System boundaries not identified | medium |
| Ambiguous event names | Event names not clear or descriptive | medium |
| Missing commands | No command triggering domain events | high |
| Wrong event tense | Events in present tense instead of past | medium |
| Missing policies | Business rules not documented | high |
