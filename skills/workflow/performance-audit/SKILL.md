...
author: Abdox
description: |
  ULTRA-ADVANCED Performance Audit - Performance audit - profiling, baseline, bottlenecks, load testing, regression
  CAPABILITIES:
  - 8 anti-pattern detection patterns with severity scoring
  - Compliance scoring (A-F grade) with weighted severity model
  - Standards-based detection (SRE Handbook; Web Vitals; JMeter)
  - Automated fix suggestion generation
  - Directory scanning with aggregated reporting
  TRIGGER PHRASES: "performance audit, performance review, optimization audit"
...
# Performance Audit - ULTRA-ADVANCED v2.0

## Overview

Performance audit - profiling, baseline, bottlenecks, load testing, regression. This guard scans codebases for violations, scores compliance,
