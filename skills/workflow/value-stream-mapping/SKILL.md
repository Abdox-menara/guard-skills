...
author: Abdox
description: |
  ULTRA-ADVANCED Value Stream Mapping - Value stream mapping - process optimization, waste identification, cycle time analysis
  ...
  TRIGGER PHRASES: "value stream mapping, process optimization, lean"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Value Stream Mapping - ULTRA-ADVANCED v1.0

## Overview

Value stream mapping - process optimization, waste identification, cycle time analysis. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Value not defined | Customer value not specified | medium |
| No cycle time data | Process times not measured | high |
| Wait times ignored | Queue times not captured | medium |
| Information flow missing | Communication paths undocumented | high |
| No improvement targets | Baseline without target state | medium |
