...
author: Abdox
description: |
  ULTRA-ADVANCED Pair Programming - Pair programming workflow - driver/navigator roles, rotation timing, collaboration patterns
  ...
  TRIGGER PHRASES: "pair programming, pairing, mob programming"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Pair Programming - ULTRA-ADVANCED v1.0

## Overview

Pair programming workflow - driver/navigator roles, rotation timing, collaboration patterns. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No role switching | Driver never changes during session | medium |
| Communication gap | Silent pairing without discussion | medium |
| Pace mismatch | One person dominates keyboard | medium |
| No breaks scheduled | Too long without role switching | low |
| Tool problems | Environment sharing issues | low |
