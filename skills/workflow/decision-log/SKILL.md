...
author: Abdox
description: |
  ULTRA-ADVANCED Decision Log - Decision log - ADR format, rationale, alternatives, impact, review
  CAPABILITIES:
  - 8 anti-pattern detection patterns with severity scoring
  - Compliance scoring (A-F grade) with weighted severity model
  - Standards-based detection (ADR by Michael Nygard; Y-Statements)
  - Automated fix suggestion generation
  - Directory scanning with aggregated reporting
  TRIGGER PHRASES: "decision log, architecture decision record, adr"
...
# Decision Log - ULTRA-ADVANCED v2.0

## Overview

Decision log - ADR format, rationale, alternatives, impact, review. This guard scans codebases for violations, scores compliance,
