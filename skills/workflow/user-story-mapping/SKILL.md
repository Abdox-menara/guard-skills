...
author: Abdox
description: |
  ULTRA-ADVANCED User Story Mapping - User story mapping - backlog organization, release slicing, persona workflow discovery
  ...
  TRIGGER PHRASES: "story mapping, user story mapping, backlog"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# User Story Mapping - ULTRA-ADVANCED v1.0

## Overview

User story mapping - backlog organization, release slicing, persona workflow discovery. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Missing user tasks | Activities without breakdown steps | medium |
| No release slice | MVP or minimal release not identified | high |
| Missing personas | Different user types ignored | high |
| Wrong activity order | Workflow sequence incorrect | high |
| No technical stories | Only UI-facing user stories | medium |
