...
author: Abdox
description: |
  ULTRA-ADVANCED Security Testing Workflow - Security testing workflow - SAST, DAST, penetration testing, dependency scanning
  ...
  TRIGGER PHRASES: "security testing, penetration test, vulnerability scan"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Security Testing Workflow - ULTRA-ADVANCED v1.0

## Overview

Security testing workflow - SAST, DAST, penetration testing, dependency scanning. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No SAST integration | Static analysis not in CI pipeline | critical |
| No dependency scanning | Vulnerable dependencies unchecked | critical |
| No DAST in staging | Dynamic testing not performed | high |
| No pen test schedule | Manual pen testing not planned | high |
| No vulnerability DB | Findings not tracked | medium |
