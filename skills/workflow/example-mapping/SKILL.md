...
author: Abdox
description: |
  ULTRA-ADVANCED Example Mapping - Example mapping workshop - rules, examples, questions, acceptance criteria definition
  ...
  TRIGGER PHRASES: "example mapping, specification by example, acceptance criteria"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Example Mapping - ULTRA-ADVANCED v1.0

## Overview

Example mapping workshop - rules, examples, questions, acceptance criteria definition. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Rules missing | No constraints documented for examples | medium |
| Ambiguous examples | Example context or data unclear | high |
| Too many examples | Scope creep in example mapping | low |
| Unanswered questions | Clarifications not tracked | medium |
| Rule without example | Abstract rule without concrete example | high |
