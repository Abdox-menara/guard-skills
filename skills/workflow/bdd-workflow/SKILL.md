...
author: Abdox
description: |
  ULTRA-ADVANCED Bdd Workflow - BDD workflow - Gherkin feature files, scenario structure, step definitions
  ...
  TRIGGER PHRASES: "bdd, behavior driven development, gherkin"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Bdd Workflow - ULTRA-ADVANCED v1.0

## Overview

BDD workflow - Gherkin feature files, scenario structure, step definitions. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Scenario too complex | More than 10 steps per scenario | medium |
| Vague scenario title | Non-descriptive scenario name | low |
| Missing Given context | No preconditions defined for scenario | high |
| When without Then | Action without assertion or verification | high |
| UI coupling in steps | Steps depend on UI selectors | medium |
