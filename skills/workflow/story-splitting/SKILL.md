...
author: Abdox
description: |
  ULTRA-ADVANCED Story Splitting - User story splitting - vertical slicing, SPIDR, independent value, INVEST
  CAPABILITIES:
  - 8 anti-pattern detection patterns with severity scoring
  - Compliance scoring (A-F grade) with weighted severity model
  - Standards-based detection (SPIDIR; INVEST principles)
  - Automated fix suggestion generation
  - Directory scanning with aggregated reporting
  TRIGGER PHRASES: "story splitting, vertical slicing, story decomposition"
...
# Story Splitting - ULTRA-ADVANCED v2.0

## Overview

User story splitting - vertical slicing, SPIDR, independent value, INVEST. This guard scans codebases for violations, scores compliance,
