...
author: Abdox
description: |
  ULTRA-ADVANCED Acceptance Testing - Acceptance testing workflow - criteria definition, UAT, automation, sign-off process
  ...
  TRIGGER PHRASES: "acceptance testing, user acceptance test, uat"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Acceptance Testing - ULTRA-ADVANCED v1.0

## Overview

Acceptance testing workflow - criteria definition, UAT, automation, sign-off process. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Criteria not testable | Vague acceptance criteria | high |
| No automation strategy | Manual UAT without plan | medium |
| Missing sign-off process | No formal acceptance gate | high |
| Environment mismatch | Test env differs from production | medium |
| No regression scope | UAT without regression testing | medium |
