...
author: Abdox
description: |
  ULTRA-ADVANCED Code Review Workflow - Code review process - review types, checklists, feedback patterns, turnaround time
  ...
  TRIGGER PHRASES: "code review workflow, pr review, code review process"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Code Review Workflow - ULTRA-ADVANCED v1.0

## Overview

Code review process - review types, checklists, feedback patterns, turnaround time. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| PR too large | More than 400 lines per review | medium |
| Slow review turnaround | Over 24 hours for initial review | high |
| Nitpicking style | Style comments dominate substance | low |
| Missing PR description | No context provided for review | high |
| Comments unresolved | Review thread abandoned without resolution | medium |
