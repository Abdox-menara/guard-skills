...
author: Abdox
description: |
  ULTRA-ADVANCED Specification By Example - Specification by Example - living documentation, executable specs, collaborative refinement
  ...
  TRIGGER PHRASES: "specification by example, living documentation, SBE"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Specification By Example - ULTRA-ADVANCED v1.0

## Overview

Specification by Example - living documentation, executable specs, collaborative refinement. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Examples not reviewed | Missing stakeholder validation | medium |
| Missing business rules | Only examples without underlying rules | high |
| Outdated specs | Specs not updated with code changes | high |
| Examples too abstract | No concrete data in examples | low |
| No automation linkage | Specs disconnected from tests | high |
