...
author: Abdox
description: |
  ULTRA-ADVANCED Impact Mapping - Impact mapping - strategic planning, feature prioritization, assumption validation
  ...
  TRIGGER PHRASES: "impact mapping, strategic planning, feature prioritization"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Impact Mapping - ULTRA-ADVANCED v1.0

## Overview

Impact mapping - strategic planning, feature prioritization, assumption validation. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Goal not measurable | No metric for business goal | high |
| Assumptions not validated | Unverified impact path | medium |
| Missing actor | Stakeholder or persona omitted | medium |
| Too detailed scope | More than 3 levels of mapping | low |
| No delivery scope | Impact without release scope | medium |
