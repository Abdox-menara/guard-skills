...
author: Abdox
description: |
  ULTRA-ADVANCED Performance Testing Workflow - Performance testing workflow - plan, script, execute, analyze, baseline comparison
  ...
  TRIGGER PHRASES: "performance testing, load testing, stress testing"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Performance Testing Workflow - ULTRA-ADVANCED v1.0

## Overview

Performance testing workflow - plan, script, execute, analyze, baseline comparison. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No baseline | No performance baseline established | high |
| No realistic data | Test data not representative | high |
| One scenario only | Only happy path tested | medium |
| No SLA defined | Target response times undefined | high |
| Environment mismatch | Test env differs from production specs | high |
