...
author: Abdox
description: |
  ULTRA-ADVANCED Ml Pipeline Workflow - ML pipeline workflow - data prep, training, evaluation, deployment, monitoring
  ...
  TRIGGER PHRASES: "ml pipeline, machine learning workflow, model training"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Ml Pipeline Workflow - ULTRA-ADVANCED v1.0

## Overview

ML pipeline workflow - data prep, training, evaluation, deployment, monitoring. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Data leakage | Future data leaks into training set | critical |
| No experiment tracking | Model runs unreproducible | high |
| No model versioning | Model artifacts not versioned | high |
| Skewed train/test split | Non-representative data split | high |
| No drift monitoring | Production model degradation unseen | medium |
