...
author: Abdox
description: |
  ULTRA-ADVANCED Definition Of Done - Definition of Done - quality gates, verification, team agreement, enforcement
  CAPABILITIES:
  - 8 anti-pattern detection patterns with severity scoring
  - Compliance scoring (A-F grade) with weighted severity model
  - Standards-based detection (Scrum DoD; INVEST; Scrum.org)
  - Automated fix suggestion generation
  - Directory scanning with aggregated reporting
  TRIGGER PHRASES: "definition of done, done criteria, quality gate"
  STANDARDS: Scrum DoD; INVEST; Scrum.org
  ENVIRONMENT: Works with any codebase, any language, any framework.
  SECURITY: Read-only analysis.
---

# Definition Of Done - ULTRA-ADVANCED v2.0

## Overview

Definition of Done - quality gates, verification, team agreement, enforcement. This guard scans codebases for violations, scores compliance,
