...
author: Abdox
description: |
  ULTRA-ADVANCED Technical Specification - Technical specification - architecture decisions, API contracts, data model, security review
  CAPABILITIES:
  - 8 anti-pattern detection patterns with severity scoring
  - Compliance scoring (A-F grade) with weighted severity model
  - Standards-based detection (Google Design Docs; ADR; RFC 2119)
  - Automated fix suggestion generation
  - Directory scanning with aggregated reporting
  TRIGGER PHRASES: "technical specification, tech spec, design document"
...
# Technical Specification - ULTRA-ADVANCED v2.0

## Overview

Technical specification - architecture decisions, API contracts, data model, security review. This guard scans codebases for violations, scores compliance,
