...
author: Abdox
description: |
  ULTRA-ADVANCED Atdd - Acceptance Test Driven Development - collaboration, automation, executable specifications
  ...
  TRIGGER PHRASES: "acceptance tdd, atdd, executable specifications"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Atdd - ULTRA-ADVANCED v1.0

## Overview

Acceptance Test Driven Development - collaboration, automation, executable specifications. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No test-first approach | Implementation before acceptance test | high |
| Business language missing | Tech jargon in acceptance tests | medium |
| No automation strategy | Manual acceptance testing only | medium |
| Missing edge cases | Only happy path scenarios covered | high |
| Test brittleness | Brittle selectors or test data | medium |
