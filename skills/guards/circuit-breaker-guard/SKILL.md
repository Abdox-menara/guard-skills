...
author: Abdox
description: |
  ULTRA-ADVANCED Circuit Breaker Guard - Circuit breaker pattern validation - thresholds, recovery, fallbacks, monitoring
  ...
  TRIGGER PHRASES: "circuit breaker, resilience pattern, fault tolerance"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Circuit Breaker Guard - ULTRA-ADVANCED v1.0

## Overview

Circuit breaker pattern validation - thresholds, recovery, fallbacks, monitoring. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Missing circuit breaker | No protection on external service call | high |
| No failure threshold | Circuit breaker never opens | high |
| No recovery timeout | Circuit never transitions to half-open | high |
| Threshold too high | Too many failures before circuit opens | medium |
| No fallback | Open circuit without fallback handler | medium |
