...
author: Abdox
description: |
  ULTRA-ADVANCED Ssrf Guard - Server-side request forgery prevention - URL validation, IP blocking, scheme restrictions
  ...
  TRIGGER PHRASES: "ssrf check, server side request forgery"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Ssrf Guard - ULTRA-ADVANCED v1.0

## Overview

Server-side request forgery prevention - URL validation, IP blocking, scheme restrictions. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| User-controlled URL | URL constructed directly from user input | critical |
| Internal IP exposure | Requests to private IP ranges allowed | high |
| Open URL redirect | Open redirect with user-controlled target | high |
| DNS rebinding vulnerability | No hostname validation after DNS | critical |
| Metadata endpoint access | Cloud metadata endpoints accessible | critical |
