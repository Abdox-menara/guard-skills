---
name: long-method-guard
version: 1.0.0
author: Abdox
description: |
  ULTRA-ADVANCED Long Method Guard - Long method detection - extraction opportunities, parameter count, nesting depth
  ...
  TRIGGER PHRASES: "long method, extract method, function length"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Long Method Guard - ULTRA-ADVANCED v1.0

## Overview

Long method detection - extraction opportunities, parameter count, nesting depth. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Excessive method length | Function exceeds 50 lines | medium |
| Too many parameters | More than 5 function parameters | medium |
| Too many branches | High cyclomatic complexity in method | medium |
| Too many local variables | More than 10 local variables | low |
| Deep nesting | More than 3 levels of nesting | medium |
