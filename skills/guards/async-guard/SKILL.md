...
author: Abdox
description: |
  ULTRA-ADVANCED Async Guard - Async/await pattern validation - proper usage, error handling, cancellation
  ...
  TRIGGER PHRASES: "async await, asynchronous code, promise"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Async Guard - ULTRA-ADVANCED v1.0

## Overview

Async/await pattern validation - proper usage, error handling, cancellation. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Missing await | Async call without await keyword | critical |
| Async void function | Fire-and-forget without error handling | high |
| Blocking in async context | Sleep/Result used in async method | high |
| Missing cancellation | CancellationToken not supported | medium |
| Async in constructor | Async work performed in constructor | high |
