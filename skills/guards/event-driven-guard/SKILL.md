---
name: event-driven-guard
version: 1.0.0
author: Abdox
description: |
  ULTRA-ADVANCED Event Driven Guard - Event-driven architecture validation - schema, channels, handlers, idempotency, ordering
  ...
  TRIGGER PHRASES: "event driven, event architecture, pub sub"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Event Driven Guard - ULTRA-ADVANCED v1.0

## Overview

Event-driven architecture validation - schema, channels, handlers, idempotency, ordering. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Missing event schema | Event without defined schema | high |
| Event too large | Event carrying excessive data | medium |
| Missing dead letter | Failed events not tracked | high |
| No idempotency key | Duplicate event processing risk | critical |
| Event ordering assumption | Wrong assumption about event order | high |
...
- [event-sourcing-guard](../event-sourcing-guard/SKILL.md)
