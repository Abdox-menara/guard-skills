...
author: Abdox
description: |
  ULTRA-ADVANCED Api Contract Guard - API contract compliance validation between providers and consumers
  ...
  TRIGGER PHRASES: "api contract, contract testing, provider consumer"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Api Contract Guard - ULTRA-ADVANCED v1.0

## Overview

API contract compliance validation between providers and consumers. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.
...
| Missing endpoint | Endpoints defined in contract not implemented | high |
| Parameter mismatch | Request parameters differ from contract | high |
| Response mismatch | Response structure does not match contract | high |
| Content type mismatch | Wrong media type in request/response | medium |
...
- [contract-testing](../../tools/contract-testing/SKILL.md)
