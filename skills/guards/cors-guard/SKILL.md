...
author: Abdox
description: |
  ULTRA-ADVANCED Cors Guard - CORS configuration validation and security best practices
  ...
  TRIGGER PHRASES: "cors check, cross origin, cors security"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Cors Guard - ULTRA-ADVANCED v1.0

## Overview

CORS configuration validation and security best practices. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Wildcard CORS origin | Access-Control-Allow-Origin set to * | critical |
| Credentials with wildcard | Credentials flag with wildcard origin | critical |
| Exposed headers too permissive | Too many exposed header names | high |
| Allow methods too broad | Allow-Methods uses * wildcard | high |
| Preflight cache too long | Max-Age exceeds 86400 seconds | medium |
