...
author: Abdox
description: |
  ULTRA-ADVANCED Naming Guard - Naming convention validation - consistency, readability, anti-patterns
  ...
  TRIGGER PHRASES: "naming check, naming conventions, code style"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Naming Guard - ULTRA-ADVANCED v1.0

## Overview

Naming convention validation - consistency, readability, anti-patterns. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Inconsistent naming style | camelCase and snake_case mixed | medium |
| Abbreviated names | Short unclear variable names used | medium |
| Type-prefixed names | Hungarian notation prefixes detected | low |
| Single-letter names | Single char names in non-trivial scope | medium |
| Boolean not predicative | Boolean var missing is/has/should prefix | low |
