---
name: cyclomatic-guard
version: 1.0.0
author: Abdox
description: |
  ULTRA-ADVANCED Cyclomatic Guard - Cyclomatic complexity validation - McCabe metrics, refactoring targets
  ...
  TRIGGER PHRASES: "cyclomatic complexity, code complexity, McCabe"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Cyclomatic Guard - ULTRA-ADVANCED v1.0

## Overview

Cyclomatic complexity validation - McCabe metrics, refactoring targets. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| High complexity | Cyclomatic complexity > 10 | medium |
| Very high complexity | Cyclomatic complexity > 20 | high |
| Excessive conditionals | Deeply nested if/else chains | medium |
| Complex boolean | Compound condition with 5+ terms | low |
| Long switch chain | Switch with more than 5 cases | medium |
