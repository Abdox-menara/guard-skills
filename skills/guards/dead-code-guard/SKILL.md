...
author: Abdox
description: |
  ULTRA-ADVANCED Dead Code Guard - Dead code detection - unused imports, functions, variables, unreachable code
  ...
  TRIGGER PHRASES: "dead code, unused code, code cleanup"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Dead Code Guard - ULTRA-ADVANCED v1.0

## Overview

Dead code detection - unused imports, functions, variables, unreachable code. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Unused import | Import never referenced in module | medium |
| Unused function | Function defined but never called | medium |
| Unused variable | Variable declared but never read | medium |
| Unreachable code | Code after return or raise statement | high |
| Empty exception block | Exception caught without handling | high |
