---
name: repository-pattern-guard
version: 2.0.0
author: Abdox
description: |
  ULTRA-ADVANCED Repository Pattern Guard - Repository pattern validation - abstraction, interface design, query methods
  CAPABILITIES:
  - 8 anti-pattern detection patterns with severity scoring
  - Compliance scoring (A-F grade) with weighted severity model
  - Standards-based detection (Martin Fowler Repository; Evans DDD)
  - Automated fix suggestion generation
  - Directory scanning with aggregated reporting
  TRIGGER PHRASES: "repository pattern, data access, persistence"
  STANDARDS: Martin Fowler Repository; Evans DDD
  ENVIRONMENT: Works with any codebase, any language, any framework.
  SECURITY: Read-only analysis.
---

# Repository Pattern Guard - ULTRA-ADVANCED v2.0

## Overview

Repository pattern validation - abstraction, interface design, query methods. This guard scans codebases for violations, scores compliance,
