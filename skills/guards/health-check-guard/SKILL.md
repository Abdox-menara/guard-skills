...
author: Abdox
description: |
  ULTRA-ADVANCED Health Check Guard - Health check endpoint validation - liveness, readiness, startup probes, dependencies
  ...
  TRIGGER PHRASES: "health check, liveness probe, readiness probe"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Health Check Guard - ULTRA-ADVANCED v1.0

## Overview

Health check endpoint validation - liveness, readiness, startup probes, dependencies. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Missing liveness probe | No restart on deadlock or hang | critical |
| Missing readiness probe | Traffic sent before service ready | high |
| Probe too expensive | Full database query on every probe | medium |
| Startup probe missing | Slow startup not handled | medium |
| No dependency check | Health passes with broken dependency | high |
...
- [env-check-guard](../env-check-guard/SKILL.md)
