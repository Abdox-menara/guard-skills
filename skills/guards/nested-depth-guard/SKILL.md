---
name: nested-depth-guard
version: 1.0.0
author: Abdox
description: |
  ULTRA-ADVANCED Nested Depth Guard - Nesting depth validation - conditionals, loops, callback nesting, refactoring targets
  ...
  TRIGGER PHRASES: "nesting depth, nested code, callback hell"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Nested Depth Guard - ULTRA-ADVANCED v1.0

## Overview

Nesting depth validation - conditionals, loops, callback nesting, refactoring targets. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Deep conditional nesting | More than 3 levels of if/else | medium |
| Callback hell | Callbacks nested more than 3 levels | high |
| Nested loops with conditions | Loops containing conditionals > 2 deep | medium |
| Promise chain too long | More than 3 chained .then() calls | medium |
| Try-catch nesting | Nested try blocks | low |
