...
author: Abdox
description: |
  ULTRA-ADVANCED Idor Guard - Insecure Direct Object Reference detection - authorization checks, predictable IDs, mass assignment
  ...
  TRIGGER PHRASES: "idor check, broken access control, object reference"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Idor Guard - ULTRA-ADVANCED v1.0

## Overview

Insecure Direct Object Reference detection - authorization checks, predictable IDs, mass assignment. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Direct ID in URL | Sequential IDs in routes without authz | critical |
| Missing ownership check | No authorization on resource access | critical |
| Mass assignment | Unfiltered user params in update operations | high |
| Missing authorization check | Endpoint without auth check | critical |
| Predictable resource ID | Guessable resource identifiers used | high |
