---
name: dependency-injection-guard
version: 2.0.0
author: Abdox
description: |
  ULTRA-ADVANCED Dependency Injection Guard - DI/IoC validation - constructor injection, service locator, container setup, captive dependencies
  CAPABILITIES:
  - 8 anti-pattern detection patterns with severity scoring
  - Compliance scoring (A-F grade) with weighted severity model
  - Standards-based detection (Mark Seemann DI.NET; Composition Root)
  - Automated fix suggestion generation
  - Directory scanning with aggregated reporting
  TRIGGER PHRASES: "dependency injection, ioc, di container"
...
# Dependency Injection Guard - ULTRA-ADVANCED v2.0

## Overview

DI/IoC validation - constructor injection, service locator, container setup, captive dependencies. This guard scans codebases for violations, scores compliance,
