---
name: message-queue-guard
version: 1.0.0
author: Abdox
description: |
  ULTRA-ADVANCED Message Queue Guard - Message queue validation - producers, consumers, reliability, dead letter queues
  ...
  TRIGGER PHRASES: "message queue, queue management, consumer pattern"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Message Queue Guard - ULTRA-ADVANCED v1.0

## Overview

Message queue validation - producers, consumers, reliability, dead letter queues. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| No retry on failure | Message lost on processing failure | critical |
| Missing dead letter queue | Failed messages discarded | high |
| No idempotent consumer | Duplicate message processing | high |
| No message TTL | Unbounded queue growth | medium |
| Consumer prefetch too high | Too many unacknowledged messages | medium |
