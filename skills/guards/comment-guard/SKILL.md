...
author: Abdox
description: |
  ULTRA-ADVANCED Comment Guard - Comment quality validation - meaningful vs noise, stale comments, missing docs
  ...
  TRIGGER PHRASES: "comment check, comment quality, documentation"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Comment Guard - ULTRA-ADVANCED v1.0

## Overview

Comment quality validation - meaningful vs noise, stale comments, missing docs. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Commented out code | Old code left in comments | medium |
| Noise comments | Comment stating the obvious | low |
| TODO without context | No issue reference or date on TODO | low |
| Wrong comment | Comment contradicts actual code | medium |
| Missing public API docs | Public API undocumented | high |
