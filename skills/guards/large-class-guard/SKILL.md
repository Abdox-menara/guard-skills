---
name: large-class-guard
version: 1.0.0
author: Abdox
description: |
  ULTRA-ADVANCED Large Class Guard - Large class detection - single responsibility, cohesion, coupling analysis
  ...
  TRIGGER PHRASES: "large class, god class, single responsibility"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Large Class Guard - ULTRA-ADVANCED v1.0

## Overview

Large class detection - single responsibility, cohesion, coupling analysis. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Too many methods | Class with more than 20 methods | medium |
| Too many fields | Class with more than 10 fields | medium |
| Too many responsibilities | Class handles multiple domain concepts | high |
| High coupling | Class depends on too many other types | medium |
| Low cohesion | Methods operate on few class fields | high |
