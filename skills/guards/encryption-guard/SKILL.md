...
author: Abdox
description: |
  ULTRA-ADVANCED Encryption Guard - Encryption best practices - algorithm strength, key management, hashing, IV handling
  ...
  TRIGGER PHRASES: "encryption check, cryptography, hashing"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Encryption Guard - ULTRA-ADVANCED v1.0

## Overview

Encryption best practices - algorithm strength, key management, hashing, IV handling. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Weak encryption algorithm | DES, RC4, or similar weak cipher used | critical |
| Weak hash function | MD5 or SHA-1 used for security | critical |
| Hardcoded encryption key | Key found in source code | critical |
| ECB mode usage | ECB mode in block cipher | critical |
| No salt on hash | Password hash without salt | high |
