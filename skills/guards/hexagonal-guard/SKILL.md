...
author: Abdox
description: |
  ULTRA-ADVANCED Hexagonal Guard - Hexagonal/ports-and-adapters architecture validation - clean dependency flow
  ...
  TRIGGER PHRASES: "hexagonal architecture, ports and adapters, clean architecture"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Hexagonal Guard - ULTRA-ADVANCED v1.0

## Overview

Hexagonal/ports-and-adapters architecture validation - clean dependency flow. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Port interface violation | Domain depends on infrastructure detail | critical |
| Adapter layer leak | Infrastructure detail leaks into application | high |
| Layer violation | Wrong import direction across layers | critical |
| Input port missing | No inbound boundary interface defined | medium |
| Output port missing | No outbound boundary interface defined | medium |
