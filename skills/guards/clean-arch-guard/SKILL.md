...
author: Abdox
description: |
  ULTRA-ADVANCED Clean Arch Guard - Clean architecture layer dependency validation - entities, use cases, interfaces, infrastructure
  ...
  TRIGGER PHRASES: "clean architecture, dependency rule, entity use case"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Clean Arch Guard - ULTRA-ADVANCED v1.0

## Overview

Clean architecture layer dependency validation - entities, use cases, interfaces, infrastructure. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Dependency rule violation | Inner layer imports outer layer | critical |
| Entity leak | Entities referenced outside domain layer | high |
| Use case bypass | Controller directly accesses repository | high |
| Framework coupling in core | Framework dependency in domain layer | critical |
