---
name: duplicate-code-guard
version: 1.0.0
author: Abdox
description: |
  ULTRA-ADVANCED Duplicate Code Guard - Code duplication detection - exact, near-duplicate, DRY principle enforcement
  ...
  TRIGGER PHRASES: "duplicate code, code duplication, dry principle"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Duplicate Code Guard - ULTRA-ADVANCED v1.0

## Overview

Code duplication detection - exact, near-duplicate, DRY principle enforcement. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.

## Detection Patterns

| Pattern | Description | Severity |
|---|---|---|
| Exact duplicate | Identical code blocks found | medium |
| Near duplicate >80% | Similar code with >80% match | medium |
| Copy-paste with rename | Only identifiers differ between blocks | medium |
| Duplicate logic | Same algorithm with different implementation | low |
| Magic number repetition | Same literal used repeatedly | low |
