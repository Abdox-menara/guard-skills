...
author: Abdox
description: |
  ULTRA-ADVANCED Ddd Guard - Domain-driven design validation - aggregates, entities, bounded contexts, repositories
  ...
  TRIGGER PHRASES: "ddd check, domain driven design, bounded context"
  
  ENVIRONMENT: Works with any codebase, any language, any framework.

---

# Ddd Guard - ULTRA-ADVANCED v1.0

## Overview

Domain-driven design validation - aggregates, entities, bounded contexts, repositories. This skill scans codebases for violations, scores compliance, and generates actionable recommendations.
...
| Ubiquitous language drift | Domain terms not reflected in code | high |
| Bounded context leak | Cross-context coupling detected | critical |
| Repository pattern violation | Direct data access in domain layer | high |
| Entity vs Value Object misuse | Mutable object used as value object | medium |
